...
steps:
  ...
  hepatic-peripheral-arterial-disease---primary:
    run: hepatic-peripheral-arterial-disease---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  peripheral-arterial-disease---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: hepatic-peripheral-arterial-disease---primary/output
